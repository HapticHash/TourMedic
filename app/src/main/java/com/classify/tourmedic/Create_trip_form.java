        ...
        edit_first = (EditText) findViewById(R.id.number_edit_text1);
                ...
                btn2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mDatabaseCreateTrip.child(no).child("Trips").child("Trip" + total_trip_int).child("places").child("places" + j).child("startdate").setValue("26-11-2027");
                        mDatabaseCreateTrip.child(no).child("Trips").child("Trip" + total_trip_int).child("places").child("places" + j).child("enddate").setValue("27-10-2028");
                        j=2;
                        //count = count+1;
