...
public class For_you_tab extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public For_you_tab(String placename) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.for_you_fragment, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerView_for_you);
...
//        });
    ...
    public void getInfo() {
        al1.clear();
        mDatabaseCity.child(no).child(placename).child("for you").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
