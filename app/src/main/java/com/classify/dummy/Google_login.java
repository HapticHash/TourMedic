...
public class Google_login extends AppCompatActivity {
    ...
    DatabaseReference mDatabaseUnseen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseUnseen = FirebaseDatabase.getInstance().getReference().child("Unseen");
        mDatabaseUnseen.keepSynced(true);
    ...
    public void WriteData() {
        ...
        mDatabaseCreateTrip.child(total1 + "").child("email").setValue(email);
        mDatabaseCreateTrip.child(total1 + "").child("no").setValue(total1+"");
        mDatabaseCreateTrip.child(total1 + "").child("totalTrip").setValue("0");

        mDatabaseDayplan.child(total1 + "").child("email").setValue(email);
        mDatabaseDayplan.child(total1 + "").child("no").setValue(total1+"");
        mDatabaseDayplan.child(total1 + "").child("totalplan").setValue("0");

        mDatabaseUnseen.child(total1 + "").child("email").setValue(email);
        mDatabaseUnseen.child(total1 + "").child("no").setValue(total1+"");
        mDatabaseUnseen.child(total1 + "").child("totalunseen").setValue("0");
